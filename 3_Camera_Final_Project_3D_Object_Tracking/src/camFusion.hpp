...
//======LERNER'S MODIFICATION STARTS-Authored by Vimal kumar V
...
//src/quiz/cluster/cluster.cpp of Udacity's Sensor Fusion Nanodegree Program ===========
struct Clust
{
...
//========LERNER'S MODIFICATION-Authored by Vimal kumar V ENDS=========
