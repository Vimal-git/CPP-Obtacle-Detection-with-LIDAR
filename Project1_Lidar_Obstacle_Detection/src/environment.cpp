...
//void cityBlock(pcl::visualization::PCLVisualizer::Ptr& v
//iewer)
void cityBlock(pcl::visualization::PCLVisualizer::Ptr &viewer,ProcessPointClouds<pcl::PointXYZI> pointProcessor,pcl::PointCloud<pcl::PointXYZI>::Ptr inputCloud)
{
    ...
    //pcl::PointCloud<pcl::PointXYZI>::Ptr filterCloud = pointProcessor.FilterCloud(inputCloud,0.2,Eigen::Vector4f(-8,-5.5,-3,1),Eigen::Vector4f(30,7,0,1));
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessor.Clustering(segmentCloud.first,0.53,10,500);//pointProcessor.Clustering(segmentCloud.first,0.53,10,500);
...
int main (int argc, char** argv)
{
    ...
    // code written for PCD streaming**********
